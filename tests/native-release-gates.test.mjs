...
test('native cold launch remains branded until remote content or local recovery is visible', () => {
  ...
  assert.match(nativeDelegate, /override func viewDidLayoutSubviews\(\)/)
  assert.match(nativeDelegate, /view\.safeAreaInsets\.top/)
  assert.match(nativeDelegate, /webView\.frame = releaseFrame/)
