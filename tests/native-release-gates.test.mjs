...
test('native cold launch remains branded until remote content or local recovery is visible', () => {
  ...
  assert.match(nativeDelegate, /override func viewDidAppear\(_ animated: Bool\)/)
  assert.match(nativeDelegate, /super\.viewDidAppear\(animated\)/)
  assert.match(nativeDelegate, /installReleaseWebViewConstraints\(\)/)
