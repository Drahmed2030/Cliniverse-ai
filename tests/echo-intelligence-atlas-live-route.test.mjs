...
test('Echo is reachable from exactly one entry point (the Learn Echo track, now the Echo v2 workspace) — no second Echo navigation system was created', () => {
  ...
  assert.equal(learn.includes('/labs/echo-preview'), false)
