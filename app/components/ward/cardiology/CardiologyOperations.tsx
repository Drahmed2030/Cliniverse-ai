  ...
  return (
    <section aria-labelledby="cardiology-operations-title" style={{ color: C.text }}>
      <div style={{ ...panelStyle, background: `linear-gradient(145deg, ${C.panel}, ${C.elevated})`, marginBottom: 12 }}>
        <div style={{ color: C.teal, fontSize: 10, fontWeight: 900, letterSpacing: 1 }}>CLINIVERSE PRO · CARDIOLOGY LEARNING</div>
        ...
        <p style={{ margin: 0, color: C.sub, fontSize: 12, lineHeight: 1.65 }}>
          Practise on-call coordination, pathway census, surgical lists, notes and orders accountability, and structured handover with fictional records.
        </p>
