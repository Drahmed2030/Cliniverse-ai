          ...
          <div style={{ background:'rgba(255,255,255,0.04)', backdropFilter:'blur(20px)', borderRadius:20, padding:18, marginBottom:14, border:'1px solid rgba(139,92,246,0.15)', boxShadow:'none' }}>
            ...
            <div style={{ marginBottom:12, position:'relative' }}>
              ...
              {show1 && search1 && !drug1 && filtered1.length > 0 && (
                <div style={{ position:'absolute', top:'100%', left:0, right:0, background:'rgba(28,10,50,0.97)', backdropFilter:'blur(20px)', borderRadius:14, border:'1px solid rgba(139,92,246,0.15)', boxShadow:'0 8px 32px rgba(0,0,0,0.6)', zIndex:50, marginTop:4, overflow:'hidden' }}>
                  {filtered1.map(d=>(
