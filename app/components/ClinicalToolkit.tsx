      ...
      <div style={{
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:12}}>
          {[
            ...
            <div key={r.l} style={{background:'var(--bg-card,rgba(255,255,255,0.88))',borderRadius:12,padding:'10px 10px'}}>
        ...
        <div style={{background:'var(--bg-card,rgba(255,255,255,0.88))',borderRadius:12,padding:'10px 12px',marginBottom:10,border:`1px solid rgba(255,255,255,0.08)`}}>
