    ...
    return (
      <div style={{fontFamily:'-apple-system,sans-serif',paddingBottom:20}}>
        ...
        <div style={{background:`${c.color}12`,borderRadius:20,padding:'18px',marginBottom:14,border:`1px solid ${c.color}30`,boxShadow:`0 6px 24px ${c.color}15`}}>
          ...
          {c.details&&(
            <div style={{background:'var(--bg-card,rgba(255,255,255,0.88))',borderRadius:14,padding:'12px 14px',border:'1px solid rgba(255,255,255,0.18)'}}>
        ...
        {/* Action */}
        <div style={{background:'rgba(255,255,255,0.88)',borderRadius:18,padding:'16px',marginBottom:14,border:`1px solid ${c.color}25`}}>
      ...
      <div style={{background:'linear-gradient(135deg,rgba(255,69,58,0.12),rgba(0,196,180,0.08))',borderRadius:22,padding:'16px 18px',marginBottom:14,border:'1px solid rgba(255,69,58,0.2)',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
          ...
          <div style={{textAlign:'center'}}>
            ...
            <button onClick={refetch} style={{background:'rgba(255,255,255,0.88)',border:'1px solid rgba(0,196,180,0.20)',borderRadius:10,color:C.sub,padding:'6px 12px',fontSize:11,cursor:'pointer',fontWeight:600}}>
              🔄 Refresh
            </button>
          </div>
        </div>
