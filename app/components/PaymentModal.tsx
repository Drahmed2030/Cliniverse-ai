    ...
    <div style={{position:'fixed',inset:0,zIndex:500,display:'flex',alignItems:'flex-end',justifyContent:'center'}}
      ...
      <div style={{position:'relative',width:'100%',maxWidth:480,background:'linear-gradient(145deg,#12002a,#0a0015)',borderRadius:'28px 28px 0 0',padding:'8px 0 0',border:'1px solid rgba(139,92,246,0.3)',boxShadow:'0 -20px 60px rgba(139,92,246,0.3)',animation:'slideUp 0.3s ease'}}>
        ...
        <div style={{padding:'0 24px 40px'}}>
          ...
          {/* Plan toggle */}
          <div style={{display:'flex',background:'rgba(255,255,255,0.06)',borderRadius:16,padding:4,marginBottom:20,border:'1px solid rgba(255,255,255,0.12)'}}>
          ...
          {/* Features */}
          <div style={{background:'rgba(255,255,255,0.07)',borderRadius:18,padding:16,marginBottom:20,border:'1px solid rgba(255,255,255,0.07)'}}>
            {p.features.map(f=>(
