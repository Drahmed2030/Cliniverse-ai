...
const CARD_STYLES = [
  {
    ...
    icon:'🪟',
    preview:{ background:'rgba(255,255,255,0.08)', backdropFilter:'blur(16px)', border:'1.5px solid rgba(255,255,255,0.16)', borderRadius:16 },
  },
  {
    id:'solid',
    label:'Solid',
  ...
  },
  {
    ...
    icon:'🃏',
    preview:{ background:'#1a3050', border:'1px solid rgba(255,255,255,0.08)', borderRadius:20, boxShadow:'0 12px 36px rgba(0,0,0,0.45), 0 2px 8px rgba(0,0,0,0.30)' },
  },
]
  ...
  return (
    <div style={{ fontFamily:F, position:'relative' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:20 }}>
        {onClose && (
          <button onClick={onClose} style={{ background:'rgba(255,255,255,0.07)', border:'1px solid rgba(255,255,255,0.12)', borderRadius:12, padding:'9px 16px', color:'rgba(242,248,252,0.72)', fontSize:13, fontWeight:700, cursor:'pointer', fontFamily:F }}>← Back</button>
        )}
        <div>
