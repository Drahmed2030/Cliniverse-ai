...
export default function Leaderboard({ currentXP = 0, currentRank = 'Clinical Clerk' }: { currentXP?: number, currentRank?: string }) {
  ...
  const podiumGlow = (i: number) => {
    ...
    return { bg: 'rgba(255,255,255,0.14)', border: '1px solid rgba(139,92,246,0.1)', shadow: 'none' }
  }
  ...
  return (
    <div style={{ fontFamily: '-apple-system, sans-serif', paddingBottom: 20 }}>
      ...
      {/* Filter Tabs */}
      <div style={{ display: 'flex', gap: 6, marginBottom: 14, background: 'rgba(255,255,255,0.12)', backdropFilter: 'blur(12px)', borderRadius: 16, padding: 5, border: '1px solid rgba(0,196,180,0.25)' }}>
