...
export default function AdminDashboard({ onClose }: { onClose: () => void }) {
  ...
  if(!authed) return (
    <div style={{position:'fixed',inset:0,zIndex:1000,background:'radial-gradient(ellipse at 30% 20%,#1a0533 0%,#0a0015 40%,#000510 100%)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',fontFamily:'-apple-system,sans-serif'}}>
      ...
      <div style={{position:'absolute',bottom:-100,right:-100,width:400,height:400,borderRadius:'50%',background:'radial-gradient(circle,rgba(0,196,180,0.15),transparent 70%)',filter:'blur(40px)',pointerEvents:'none'}}/>
      ...
      <div style={{marginTop:32,fontSize:11,color:'rgba(0,196,180,0.25)'}}>Admin only · Cliniverse AI</div>
    </div>
  )
  ...
  return (
    <div style={{
      ...
      {/* Ambient glows */}
      <div style={{position:'fixed',top:-100,left:-100,width:400,height:400,borderRadius:'50%',background:'radial-gradient(circle,rgba(0,196,180,0.25),transparent 70%)',pointerEvents:'none',filter:'blur(40px)'}}/>
      <div style={{position:'fixed',bottom:-100,right:-100,width:400,height:400,borderRadius:'50%',background:'radial-gradient(circle,rgba(0,196,180,0.10),transparent 70%)',pointerEvents:'none',filter:'blur(40px)'}}/>
      ...
      <div style={{background:'rgba(10,0,21,0.9)',backdropFilter:'blur(40px)',borderBottom:'1px solid rgba(139,92,246,0.3)',padding:'0 20px',height:52,display:'flex',alignItems:'center',justifyContent:'space-between',position:'sticky',top:0,zIndex:100}}>
        <div style={{display:'flex',alignItems:'center',gap:10}}>
          <div style={{width:30,height:30,borderRadius:9,background:'linear-gradient(135deg,#00C4B4,#0a84ff)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:15}}>⚙️</div>
          <div>
      ...
      <div style={{padding:'16px 20px 100px'}}>
        ...
        {activeTab==='overview'&&(
          <div>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:10,marginBottom:14}}>
              {[
                {label:'Total Users',value:stats.totalUsers.toLocaleString(),icon:'👥',color:'#00C4B4',trend:'+12 today',data:weeklyUsers},
            ...
            <div style={{background:'rgba(255,255,255,0.14)',borderRadius:20,padding:18,border:'1px solid rgba(36,63,82,0.60)',marginBottom:14}}>
              ...
              {[
                ...
                {label:'Institution ($49)',count:0,amount:0,color:'#00C4B4'},
              ].map(r=>(
            ...
            <div style={{background:'rgba(255,255,255,0.14)',borderRadius:20,padding:18,border:'1px solid rgba(36,63,82,0.60)'}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
                {[
                  {icon:'📧',label:'Email All Users',color:'#00C4B4'},
        ...
        {activeTab==='users'&&(
          <div>
            ...
            <div style={{display:'flex',gap:8,marginBottom:12}}>
              {[
                {label:'Total',value:stats.totalUsers,color:'#00C4B4'},
            ...
            {filteredUsers.map(u=>(
              <div key={u.id} style={{background:'rgba(255,255,255,0.14)',borderRadius:18,padding:'14px 16px',marginBottom:8,border:'1px solid rgba(36,63,82,0.60)',display:'flex',alignItems:'center',gap:12}}>
                ...
                <div style={{textAlign:'right',flexShrink:0}}>
                  ...
                  <button style={{marginTop:6,padding:'4px 10px',borderRadius:8,border:'1px solid rgba(139,92,246,0.3)',background:'rgba(139,92,246,0.1)',color:'#6ee7e1',fontSize:10,cursor:'pointer',fontWeight:700}}>
        ...
        {activeTab==='content'&&(
          <div>
            ...
            {[
              ...
              <div key={s.section} style={{background:'rgba(255,255,255,0.14)',borderRadius:18,padding:'14px 16px',marginBottom:8,border:'1px solid rgba(36,63,82,0.60)'}}>
                <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:10}}>
                  ...
                  <button style={{padding:'6px 12px',borderRadius:10,border:'1px solid rgba(139,92,246,0.3)',background:'rgba(139,92,246,0.1)',color:'#6ee7e1',fontSize:11,cursor:'pointer',fontWeight:700}}>+ Add</button>
                </div>
            ...
            {/* Add new case button */}
            <button style={{width:'100%',padding:'16px',borderRadius:18,border:'2px dashed rgba(139,92,246,0.3)',background:'rgba(0,196,180,0.05)',color:'rgba(139,92,246,0.8)',fontSize:15,fontWeight:700,cursor:'pointer',marginTop:4}}>
              + Add New Case
            </button>
          </div>
        )}
