  ...
  if (view === 'grand_rounds' && activeGR) {
    ...
    if (grPhase === 'analysis') return (
      <div style={{fontFamily:'-apple-system,sans-serif',paddingBottom:20}}>
        ...
        <button onClick={()=>setGrPhase('quiz')} style={{width:'100%',padding:'15px',borderRadius:18,border:'none',background:'linear-gradient(135deg,#8b5cf6,#0a84ff)',color:'white',fontSize:15,fontWeight:800,cursor:'pointer',boxShadow:'0 6px 24px rgba(139,92,246,0.4)'}}>
          🧠 Test Knowledge →
        </button>
      </div>
    )
