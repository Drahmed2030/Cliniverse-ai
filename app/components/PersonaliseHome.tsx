    ...
    <div style={{ fontFamily:F }}>
      ...
      {tab === 'sections' && (
        <div style={{ animation:'slideIn 0.3s ease' }}>
          ...
          <div style={{ background:'var(--bg-card,rgba(255,255,255,0.88))', border:'1px solid var(--border-card,rgba(10,132,255,0.10))', borderRadius:12, padding:'10px 14px', marginTop:8 }}>
      ...
      {tab === 'tools' && (
        <div style={{ animation:'slideIn 0.3s ease' }}>
          ...
          {/* Preview */}
          <div style={{ background:'var(--bg-card,rgba(255,255,255,0.88))', border:'1px solid var(--border-card,rgba(10,132,255,0.10))', borderRadius:16, padding:'14px', marginBottom:14 }}>
        ...
        <div style={{ animation:'slideIn 0.3s ease' }}>
          ...
          <div style={{ marginBottom:16 }}>
            ...
            <input
              ...
              placeholder="Doctor"
              style={{ width:'100%', padding:'13px 14px', borderRadius:14, border:'1.5px solid rgba(0,200,184,0.28)', background:'var(--bg-card,rgba(255,255,255,0.88))', color:'var(--text-primary, #F2F8FC)', fontSize:14, outline:'none', fontFamily:F, boxSizing:'border-box' }}
            />
