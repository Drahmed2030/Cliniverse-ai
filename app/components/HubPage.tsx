        ...
        <div style={{marginBottom:14}}>
          ...
          <div style={{display:'flex',gap:10,marginBottom:10}}>
            ...
            <div onClick={()=>{setShowLive(true);onXP(5)}} style={{
              flex:2,background:D.bg2,border:`1.5px solid rgba(255,69,58,.22)`,
            ...
            <div style={{flex:1,display:'flex',flexDirection:'column',gap:10}}>
              ...
              <div onClick={()=>setShowAcademy(true)} style={{
                flex:1,background:D.bg2,border:`1.5px solid rgba(191,90,242,.22)`,
              ...
              {/* XP */}
              <div style={{
                flex:1,background:D.bg2,border:`1.5px solid rgba(255,214,10,.18)`,
          ...
          <div style={{display:'flex',gap:10}}>
            {[
              ...
              <div key={c.label} style={{
                flex:1,background:D.bg2,border:`1.5px solid ${c.color}18`,
