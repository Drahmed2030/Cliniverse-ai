          ...
          <div style={{paddingBottom:100}}>
            ...
            <div style={{padding:'0 16px'}}>
              ...
              {[
                ...
                {key:'peds',icon:'🧸',title:'Pediatrics',sub:'2 cases',color:'#8b5cf6',badge:'NEW',badgeColor:'#8b5cf6',cases:pedsCases},
              ].map(section=>(
                    ...
                    <div style={{display:'flex',gap:10,overflowX:'auto',paddingBottom:6,scrollbarWidth:'none'}}>
                      {section.cases.map((cas:any)=>(
                        <div key={cas.id} onClick={()=>{if(!cas.free&&!isPro){setShowUpgrade(true);return}setActiveCase(cas.id)}}
                          style={{flexShrink:0,width:160,background:'rgba(255,255,255,0.04)',borderRadius:18,padding:14,border:'1px solid '+cas.color+'25',cursor:'pointer',opacity:!cas.free&&!isPro?0.7:1}}>
                          <div style={{fontSize:28,marginBottom:8}}>{cas.icon}</div>
                          <div style={{fontSize:13,fontWeight:700,color:'white',marginBottom:4,lineHeight:1.3}}>{cas.title}</div>
                          <div style={{fontSize:10,color:'rgba(255,255,255,0.4)',marginBottom:8}}>{cas.dept}</div>
                          <div style={{display:'flex',gap:4}}>
                            <span style={{fontSize:10,padding:'2px 8px',borderRadius:8,background:cas.color+'15',color:cas.color,fontWeight:700}}>+{cas.xpReward} XP</span>
