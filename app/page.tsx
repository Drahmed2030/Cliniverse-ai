...
const darkTheme = {
  ...
  inputBg: 'rgba(36,63,82,0.65)',
  accent: '#00C4B4',
  segmentBg: 'rgba(36,63,82,0.65)',
...
Focus on practical clinical decision-making. Be direct and evidence-based.`,
  ...
  if(showUpgrade) return (
    <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.85)',backdropFilter:'blur(20px)',zIndex:999,display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
      <div style={{background:'linear-gradient(145deg,#0d3347,#162e3e)',borderRadius:28,padding:32,maxWidth:380,width:'100%',border:'1px solid rgba(0,196,180,0.4)',boxShadow:'0 20px 80px rgba(0,196,180,0.4)',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{background:'rgba(36,63,82,0.50)',borderRadius:16,padding:'14px 16px',marginBottom:20}}>
  ...
  if(screen==='launch') return (
    <div style={{minHeight:'100vh',width:'100vw',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'radial-gradient(ellipse at 30% 20%, #1e3d52 0%, #162e3e 40%, #000510 100%)',fontFamily:'-apple-system,sans-serif',overflow:'hidden',position:'relative'}}>
      ...
      <p style={{fontSize:10,color:'rgba(36,63,82,0.65)',letterSpacing:2}}>v5.0 · SECURE · Built by a Physician</p>
    ...
    <div style={{minHeight:'100vh',width:'100vw',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'radial-gradient(ellipse at 30% 20%, #1e3d52 0%, #162e3e 40%, #000510 100%)',fontFamily:'-apple-system,sans-serif',padding:'0 32px',textAlign:'center'}}>
      <div style={{animation:'fadeIn 0.8s ease',maxWidth:420,width:'100%'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:12,maxWidth:360,margin:'0 auto'}}>
          ...
          <button onClick={()=>setScreen('signin')} style={{padding:'16px 32px',borderRadius:16,cursor:'pointer',background:'rgba(36,63,82,0.50)',color:'rgba(255,255,255,0.55)',fontSize:15,border:'1px solid rgba(0,196,180,0.20)'}}>Sign in with existing account</button>
        </div>
      </div>
    ...
    <div style={{minHeight:'100vh',width:'100vw',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'radial-gradient(ellipse at 70% 80%, #1e3d52 0%, #162e3e 40%, #000510 100%)',fontFamily:'-apple-system,sans-serif',padding:'40px 24px'}}>
      <div style={{animation:'fadeIn 0.6s ease',width:'100%',maxWidth:420}}>
        ...
        <div style={{marginBottom:14}}>
          ...
          <input placeholder="doctor@hospital.com" style={{width:'100%',padding:'16px',borderRadius:14,border:'1px solid rgba(0,196,180,0.20)',background:'rgba(36,63,82,0.60)',color:'white',fontSize:15,outline:'none',boxSizing:'border-box'}}/>
        </div>
        <div style={{marginBottom:28}}>
          ...
          <input type="password" placeholder="••••••••" style={{width:'100%',padding:'16px',borderRadius:14,border:'1px solid rgba(0,196,180,0.20)',background:'rgba(36,63,82,0.60)',color:'white',fontSize:15,outline:'none',boxSizing:'border-box'}}/>
        </div>
            ...
            <div style={{background:'linear-gradient(145deg,rgba(15,23,42,0.97),rgba(10,15,30,0.99))',borderRadius:20,padding:18,marginBottom:14,border:'1px solid rgba(0,196,180,0.3)',boxShadow:'0 8px 40px rgba(0,196,180,0.3)'}}>
                ...
                <div style={{marginBottom:14}}>
                  ...
                  <div style={{display:'flex',flexDirection:'column',gap:6}}>
                    {[
                      ...
                      <button key={q} onClick={()=>setAiQuestion(q)} style={{background:'rgba(36,63,82,0.50)',border:'1px solid rgba(36,63,82,0.65)',borderRadius:12,padding:'10px 14px',color:'rgba(255,255,255,0.7)',fontSize:12,cursor:'pointer',textAlign:'left',fontWeight:500}}>{q}</button>
                    ))}
                  </div>
                </div>
              )}
              ...
              <div style={{display:'flex',gap:8,marginTop:8}}>
                <input
                  ...
                  style={{flex:1,padding:'12px 16px',borderRadius:14,border:'1px solid rgba(0,196,180,0.20)',background:'rgba(36,63,82,0.60)',color:'white',fontSize:13,outline:'none'}}
                />
                <button
