...
const darkTheme = {
  ...
  cardBorder: 'rgba(0,196,180,0.25)',
  text: '#ffffff',
    ...
    <div style={{minHeight:'100vh',width:'100vw',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'radial-gradient(ellipse at 30% 20%, #1e3d52 0%, #162e3e 40%, #000510 100%)',fontFamily:'-apple-system,sans-serif',overflow:'hidden',position:'relative'}}>
      ...
      <div style={{marginBottom:28,position:'relative'}}>
        <svg width={130} height={130} viewBox="0 0 120 120">
          ...
          <defs><linearGradient id="grad" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#00C4B4"/><stop offset="50%" stopColor="#0a84ff"/><stop offset="100%" stopColor="#30d158"/></linearGradient></defs>
    ...
    <div style={{minHeight:'100vh',width:'100vw',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'radial-gradient(ellipse at 30% 20%, #1e3d52 0%, #162e3e 40%, #000510 100%)',fontFamily:'-apple-system,sans-serif',padding:'0 32px',textAlign:'center'}}>
      <div style={{animation:'fadeIn 0.8s ease',maxWidth:420,width:'100%'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:12,maxWidth:360,margin:'0 auto'}}>
          ...
          <button onClick={()=>setScreen('signin')} style={{padding:'16px 32px',borderRadius:16,cursor:'pointer',background:'rgba(36,63,82,0.50)',color:'rgba(255,255,255,0.55)',fontSize:15,border:'1px solid rgba(255,255,255,0.1)'}}>Sign in with existing account</button>
        </div>
      </div>
            ...
            <div style={{background:'linear-gradient(145deg,rgba(15,23,42,0.97),rgba(10,15,30,0.99))',borderRadius:20,padding:18,marginBottom:14,border:'1px solid rgba(0,196,180,0.3)',boxShadow:'0 8px 40px rgba(0,196,180,0.3)'}}>
                ...
                <div style={{marginBottom:14}}>
                  ...
                  <div style={{display:'flex',flexDirection:'column',gap:6}}>
                    {[
                      ...
                      <button key={q} onClick={()=>setAiQuestion(q)} style={{background:'rgba(36,63,82,0.50)',border:'1px solid rgba(255,255,255,0.15)',borderRadius:12,padding:'10px 14px',color:'rgba(255,255,255,0.7)',fontSize:12,cursor:'pointer',textAlign:'left',fontWeight:500}}>{q}</button>
                    ))}
                  </div>
                </div>
              )}
              ...
              <div style={{display:'flex',gap:8,marginTop:8}}>
                ...
                <button
                  ...
                  style={{width:46,height:46,borderRadius:14,border:'none',background:aiLoading||!aiQuestion.trim()?'rgba(255,255,255,0.1)':'linear-gradient(135deg,#00C4B4,#0a84ff)',color:'white',fontSize:18,cursor:aiLoading||!aiQuestion.trim()?'not-allowed':'pointer',flexShrink:0,display:'flex',alignItems:'center',justifyContent:'center'}}
                >→</button>
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <div style={{background:'linear-gradient(145deg,#2d0a6e,#0d0030)',borderRadius:28,padding:'32px 24px 28px',marginBottom:16,textAlign:'center',border:'1px solid rgba(0,196,180,0.35)',boxShadow:'0 12px 60px rgba(0,196,180,0.3)',position:'relative',overflow:'hidden'}}>
              ...
              <div style={{display:'flex',gap:10,marginBottom:20,justifyContent:'center'}}>
                <div style={{background:'linear-gradient(135deg,#00C4B4,#0a84ff)',borderRadius:20,padding:'18px 20px',flex:1,maxWidth:160,cursor:'pointer',border:'2px solid rgba(255,255,255,0.2)',position:'relative'}}>
            ...
            {/* Institution Plan */}
            <div style={{background:'linear-gradient(135deg,rgba(10,132,255,0.12),rgba(0,196,180,0.08))',borderRadius:20,padding:20,border:'1px solid rgba(10,132,255,0.25)'}}>
