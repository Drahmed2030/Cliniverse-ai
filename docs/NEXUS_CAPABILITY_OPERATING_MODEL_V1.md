...
Status: Internal architecture decision
Branch: `epic/cardiology-operations-v1`
Review date: 2026-08-28
Release boundary: Not enabled in Apple v1
...
Every module is initially `planned_internal`. A module becomes a release candidate only after its own content, clinical, privacy, security, accessibility and interaction evidence is recorded.
...
| Nexus | Interprofessional case learning and systems-safety review | Planned internal Epic |
