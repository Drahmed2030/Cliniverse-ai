...
- Later regenerated review PDF used for founder-confirmed device review is unavailable in the current workspace. Its bytes cannot be equated with the original PDF. Prior comparison reported a creation-date difference on page 4.
...
## Next dependencies
1. Recover the exact tested regenerated PDF and its renderer recipe, or establish a new explicitly identified output for review; do not request wholesale repeat testing.
