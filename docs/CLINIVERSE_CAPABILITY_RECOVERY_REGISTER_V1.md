...
| Echo fragments in `LiveCaseViewer`, Grand Rounds and snapshots | Future Echo Learning Track | Preserve concepts; synthetic cine is internal-engine-only and blocked from learners | File-level commercial reuse rights, de-identification review, real cine ingestion and cardiology approval |
