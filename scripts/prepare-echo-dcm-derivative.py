"""Local-only DCM derivative recipe. Does not grant privacy/clinical/release approval.

Usage: python3 scripts/prepare-echo-dcm-derivative.py SOURCE_WEBM SOURCE_HTML OUTPUT_DIR
...
EVIDENCE = ROOT / "docs/echo-media-lab-2026-09-06/echo-a4c-dcm-e00476/evidence.json"
FILENAME = "echo-a4c-dcm-e00476-preview-v1.mp4"
